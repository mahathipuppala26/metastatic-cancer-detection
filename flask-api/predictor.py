...
# Custom layers used in the ViT model
...
# Preprocessing function based on model input size
...
def predict_image(image: Image.Image) -> dict:
    ...
    return {
        ...
        "vit_model_confidence": float(vit_pred),
        "cnn_model_confidence": float(cnn_pred)
    }
